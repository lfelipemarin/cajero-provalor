...
if ($_SESSION["name"]) {
    ...
    <html>
        ...
        <body>
            ...
            <header id="head" >
                <p>Asociado Provalor: Bienvenido <?php echo $_SESSION["name"]; ?><br>
                    Codigo de Asociado: <?php echo $_SESSION["cod_asociado"] ?>
                </p>
                <p><a href="cambiar_contra.php"><span id="register">Cambiar Contraseña</span></a>
                    <a href="/controller/userLogout.php"><span id="chpwd">Cerrar Sesion</span></a></p>
            </header>
